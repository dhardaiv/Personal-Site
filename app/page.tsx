    ...
    <main>
      ...
      <div className="flex justify-center items-center min-h-screen">
        <div className="flex relative w-4/5 h-[70vh] p-4 inset-0 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:48px_48px] [mask-image:radial-gradient(ellipse_at_center,black,transparent)]"></div>
          <div className="flex flex-col gap-8 p-6 absolute h-[40vh] p-4 justify-center items-center text-zinc-400" {...fadeInUpAnimation}>
            <div className="flex flex-col gap-4 md:w-3/5 tracking-wide leading-relaxed text-zinc-400">
              <p className="text-4xl mb-4 font-medium">
                hey. i&apos;m <span className="text-blue-300">daivik.</span> 
              </p>
              ...
              <div className="links">
                <a href="https://github.com/dhardaiv"><span className="text-blue-300">[github]</span></a>       <a href="https://www.linkedin.com/in/daivik-dhar-919483222/?originalSubdomain=ca"><span className="text-blue-300">[linkedin]</span></a>
              </div>
            </div>
          </div>
      </div>
